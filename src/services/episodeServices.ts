...
import { WatchTimeAttributes } from "../models/watchTimes";
  ...
  streamEpisodeToResponse: (res: Response, videoUrl: string, range: string | undefined) => {
    const filePath = path.join(__dirname, '..', '..', 'uploads', videoUrl);
      ...
      if(range){
        ...
        res.writeHead(206, head);// status 206 significa connteúdo parcial,ou seja, avisando que ainda tem mais conteúdos para serem carregados. 
